<template>
  <div
    class="tw-relative tw-flex tw-w-fit tw-items-center tw-rounded-md tw-border tw-border-solid tw-border-light-gray-stroke"
  >
    <div
      class="tw-absolute tw-h-full tw-rounded-md tw-border tw-border-solid tw-transition-all"
      :class="options[index]?.borderClass ?? defaultBorderClass"
      :style="{
        borderColor: options[index]?.borderColor ?? defaultBorderColor,
